...
(function() {
    ...
    TreeNode.prototype.buildOnlySingleNodeFromTextWithThiz = function(node, currentThis) {
        ...
        node.style = (thiz.spouse) ?
            "background: #f0f1f2; margin: 4px; margin-top:8px; padding: 2px;   word-break: break-all;white-space: normal;" :
            "background: #f0f1f2; margin: 4px; margin-top:8px; padding: 2px;   word-break: break-all; white-space: normal;"
    ...
    TreeNode.prototype.buildNodeFromText = function(node) {
        ...
        if (this.spouse) {
            ...
            button.value = this.text.id;
            divElem1.appendChild(button);*/
            ...
            /* button = document.createElement('button');
             button.innerText = "edit";
             button.value = this.spouse.text.id;
             divElem2.appendChild(button);*/
            node.appendChild(divElem2);
            node.style.display = 'flex';
            // return this.buildOnlySingleNodeFromTextWithThiz(this, node);
            return node;
        } else {
